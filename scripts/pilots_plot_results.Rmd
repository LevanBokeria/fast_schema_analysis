...
```{r each-ptp-separately, fig.width=15, fig.height=15, warning=FALSE, message=FALSE}
...
mean_diff_neighbor_non_neighbor <- 
        ...
        pivot_wider(id_cols = c(ptp_trunk,condition,new_pa_img_row_number_across_sessions),
