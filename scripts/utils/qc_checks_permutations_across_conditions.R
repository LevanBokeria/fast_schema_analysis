...
# Save the df
results_bound %>% write_csv('./results/pilots/preprocessed_data/qc_permutations_raw_across_conditions.csv')
df_percentile %>% write_csv('./results/pilots/preprocessed_data/qc_permutations_summary_across_conditions.csv')
